...
<div class="auth-container">
    <div class="auth-card">
        <div class="auth-logo">
            ...
            <h1>Extracker</h1>
            <p class="text-secondary mt-2">Log your driving sessions with precision</p>
        </div>
        ...
        <div class="tab-content" id="authTabsContent">
            ...
            <div class="tab-pane fade show active" id="login" role="tabpanel">
                <form action="php/router.php?action=login" method="POST">
            ...
            <div class="tab-pane fade" id="register" role="tabpanel">
                <form action="php/router.php?action=register" method="POST">
                    <input type="hidden" name="action" value="register">
                    <div class="mb-3">
                        <label class="form-label">Username</label>
                        <input type="text" name="username" class="form-control" placeholder="What should we call you?" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary d-flex align-items-center justify-content-center gap-2">
                        Create Account <ion-icon name="rocket-outline"></ion-icon>
                    </button>
                </form>
            </div>
        </div>
