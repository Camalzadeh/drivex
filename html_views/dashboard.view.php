...
<div class="d-flex" id="wrapper">
    <div id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush my-3">
            ...
            <a href="php/router.php?action=logout" class="list-group-item list-group-item-action bg-transparent text-danger fw-bold mt-auto">
            ...
            <div class="d-flex align-items-center">
                 <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li><a class="dropdown-item" href="php/router.php?action=logout">Logout</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <div class="container-fluid" style="padding: 20px;">
                ...
                <table id="experiencesTable" class="display" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="php/router.php?action=delete_trip" method="POST" onsubmit="return confirm('Are you sure?');" style="display:inline;">
            ...
            <div class="card">
                ...
                <div id="tab-manual" class="tab-content">
                    <form action="php/router.php?action=save_trip" method="POST" onsubmit="return validateManualForm()">
                ...
                <div id="tab-live" class="tab-content" style="display:none;">
                    ...
                    <form action="php/router.php?action=save_trip" method="POST" id="live-form" style="margin-top:20px;">
                        ...
                        <div class="experience-item">
                            ...
                            <div class="exp-content">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <form action="php/router.php?action=delete_trip" method="POST" onsubmit="return confirm('Delete this trip?');">
                                        <input type="hidden" name="session_id" value="<?php echo $trip['session_id']; ?>">
